-- ============================================================================
-- MIGRATION: Create Database udemy_bot
-- Purpose: Tạo database mới với tên udemy_bot cho production
-- Date: 2026-01-15
-- ============================================================================

-- Create database if not exists
CREATE DATABASE IF NOT EXISTS `udemy_bot` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
SELECT '✅ Database udemy_bot created successfully!' AS status;
